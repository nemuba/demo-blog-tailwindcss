...
export default class extends Controller {
  ...
  createTag(tag) {
    ...
    span.classList.add('p-2', 'text-white', 'bg-green-500', 'h-10', 'rounded-l', 'font-bold')
    span.innerHTML = tag

    div.appendChild(span)
    const removeButton = document.createElement('button')
    removeButton.innerHTML = 'X'
    removeButton.classList.add('btn-secondary', 'bg-green-400', 'text-sm', 'p-2', 'h-10', 'rounded-r-1', 'rounded-l-none', 'font-bold')
